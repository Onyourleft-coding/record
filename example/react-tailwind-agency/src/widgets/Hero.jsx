  ...
  return (
    <div className="grid justify-items-center gap-8 pb-28 relative ">
      ...
      <p className="text-xl text-gray-700  md:w-1/2 text-center">
        打造一个完美的、现象级的、充满创造力的网站打造一个完美的、现象级的、充满创造力的网站打造一个完美的、现象级的、充满创造力的网站打造一个完美的、现象级的、充满创造力的网站
      </p>
      <div>
        <button className="rounded bg-blue-500 text-base text-white py-3 px-8">
          立即试用
        </button>
        <button className="rounded bg-gray-800 text-base text-white py-3 px-8 ml-3">
          了解更多
        </button>
      </div>
